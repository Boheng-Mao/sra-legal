...
def tokenize_original_text(batch):
    return tokenizer(batch["text"], truncation=True, padding="max_length", max_length=max_length)

train_dataset = train_dataset.map(tokenize_original_text, batched=True, batch_size=8)
eval_dataset = eval_dataset.map(tokenize_original_text, batched=True, batch_size=8)
test_dataset = test_dataset.map(tokenize_original_text, batched=True, batch_size=8)
